          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 w-full items-center">
            ...
            >
              ...
              <motion.p
                ...
                transition={{ duration: 3, repeat: Infinity }}
              >
                Farmers, Calculate Your Carbon Capture and Unlock Payments for
                Sustainability.
              </motion.p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
            <motion.div className="text-center" whileHover={{ y: -10 }}>
              ...
              <p className="mt-2 text-gray-600">
                Accurately calculate how much carbon your land can capture.
              </p>
            </motion.div>
            <motion.div className="text-center" whileHover={{ y: -10 }}>
              ...
              <p className="mt-2 text-gray-600">
                Get actionable insights to improve your sustainability
                practices.
              </p>
            </motion.div>
            <motion.div className="text-center" whileHover={{ y: -10 }}>
